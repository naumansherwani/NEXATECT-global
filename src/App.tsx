      ...
      notifyChangelog({
        ...
        details: {
          ...
          backend_edge_changes_lovable_shipped: [
            ...
            "supabase/functions/contact-form/index.ts — sends to naumankhansherwani@gmail.com & naumansherwani.founder@nexatect.com; no public support@.",
          ...
          notification_routing: {
            owner_login_email: "naumansherwani.founder@nexatect.com",
          ...
          replit_action_items: [
            ...
            "Mirror owner identity in Brain to naumansherwani.founder@nexatect.com.",
        ...
        <BrowserRouter>
          ...
          <Suspense fallback={<Loading />}>
            ...
            <Routes>
              ...
              <Route path="/owner/email" element={<Navigate to="/founder" replace />} />
