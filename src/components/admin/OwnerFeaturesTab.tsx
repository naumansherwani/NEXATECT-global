...
const PLATFORM_FEATURES = [
  ...
  { industry: "Healthcare", icon: Stethoscope, color: "#ef4444", features: [
    "── Dashboard (Operations) ──",
    "Healthcare Manager — Doctors, Patients, Appointments, Pharmacy, Emergency, Lab",
    "Doctor Management — Add/edit doctors, specializations, rooms, schedules, slot duration",
    "Patient Management — Register patients, track visits, no-show history, conditions",
    "Appointment Scheduling — Book appointments, check-in, status tracking, fee management",
    "Patient Flow Board — Real-time room status & wait times",
    "AI Double Booking Guard (Auto-Reassign Doctor/Room, Auto-Reschedule + AI Email)",
    "⛔ NO AI Pricing (not applicable)",
    "DB Tables: healthcare_doctors, healthcare_patients, healthcare_appointments",
    "── CRM (Premium Only) ──",
