  ...
  const renderNavItem = (item: typeof primaryNav[0]) => {
    ...
    const link = (
      <NavLink
        ...
        className={cn(
          "ghost-sidebar-item relative text-sm text-white/88 transition-all duration-200",
          labelsVisible
  ...
  const renderCrmGroup = () => {
    const crmBtn = (
      <button
        ...
        className={cn(
          "ghost-sidebar-item text-sm text-white/88 transition-all duration-200",
          labelsVisible
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        expanded
          ? "min-h-[72px] justify-between px-2 py-4 mb-4"
          : "h-[72px] justify-center w-full mb-2"
      )}>
        <button
      ...
      <div className={cn(
        "flex-1 overflow-y-auto overflow-x-hidden pt-2 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden",
