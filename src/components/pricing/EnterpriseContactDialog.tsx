        ...
        {success ? (
          <div className="py-6 text-center space-y-4">
            ...
            <div className="text-sm text-foreground leading-relaxed px-4 space-y-2">
              ...
              <p className="text-xs pt-2">
                Direct line: <a href="mailto:connectai@nexatect.com" className="text-amber-400 hover:underline">connectai@nexatect.com</a>
              </p>
            </div>
            <Button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 px-3 py-2 flex items-center gap-2 text-xs text-muted-foreground">
              ...
              Custom proposal · Async onboarding · Email-only flow · Reply via <span className="text-amber-400">connectai@nexatect.com</span>
            </div>
            ...
            <p className="text-[11px] text-muted-foreground text-center">
              Reply within 1 business day from <span className="text-amber-400">connectai@nexatect.com</span>
            </p>
          </form>
        )}
      </DialogContent>
