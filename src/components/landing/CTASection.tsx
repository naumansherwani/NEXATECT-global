...
const CTASection = () => {
  ...
  return (
    <section className="py-28 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[hsl(35,34%,68%)]/5 rounded-full blur-[120px] animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-[hsl(214,50%,38%)]/5 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="container relative z-10 text-center space-y-10 max-w-3xl">
        <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/[0.05] border border-white/[0.08] backdrop-blur-sm">
          <Clock className="w-4 h-4 text-[hsl(35,40%,66%)]" />
        ...
        <div className="flex flex-wrap justify-center gap-4 pt-2">
          <Button
            size="lg"
            className="group bg-gradient-to-r from-[hsl(35,34%,68%)] to-[hsl(214,50%,38%)] text-white text-lg px-10 py-7 font-bold rounded-xl shadow-[0_0_40px_rgba(203,179,147,0.3)] hover:shadow-[0_0_60px_rgba(203,179,147,0.5)] hover:scale-[1.03] transition-all duration-500 border-0"
        ...
        <div className="flex flex-wrap justify-center gap-6 text-sm text-white/40">
          <span className="flex items-center gap-1.5"><Shield className="w-4 h-4 text-[hsl(35,34%,68%)]" /> No credit card</span>
          <span className="flex items-center gap-1.5"><Sparkles className="w-4 h-4 text-[hsl(35,34%,68%)]" /> Full AI access</span>
          <span className="flex items-center gap-1.5"><Clock className="w-4 h-4 text-[hsl(35,40%,66%)]" /> Cancel anytime</span>
        </div>
      </div>
    </section>
  );
