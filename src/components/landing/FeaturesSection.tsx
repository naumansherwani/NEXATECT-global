...
const FEATURES = [
  { icon: Brain, title: "AI Demand Forecasting", desc: "ML models predict demand from weather, events & trends — available for Hospitality, Airlines, Car Rental, Events & Railways.", color: "hsl(214,50%,30%)", glow: "rgba(139,92,246,0.1)" },
  ...
  { icon: TrendingUp, title: "Dynamic Pricing Engine", desc: "Real-time price optimization based on demand, competition & capacity — for Hospitality, Airlines, Car Rental, Events & Railways.", color: "hsl(35,34%,68%)", glow: "rgba(16,185,129,0.1)" },
  { icon: Users, title: "Client Scoring & VIP Detection", desc: "AI scores every client — identify VIPs, repeat customers, and risk signals automatically. Available for all industries.", color: "hsl(214,50%,38%)", glow: "rgba(59,130,246,0.1)" },
  { icon: BarChart3, title: "Revenue & Scheduling Optimizer", desc: "Turnover analysis and profit tracking for all industries. Gap-filling available for Hospitality.", color: "hsl(35,40%,66%)", glow: "rgba(245,158,11,0.1)" },
  { icon: Sparkles, title: "AI-Powered Automation", desc: "Automate repetitive tasks — AI handles scheduling, reminders & follow-ups across all 8 industries.", color: "hsl(35,34%,68%)", glow: "rgba(203,179,147,0.1)" },
